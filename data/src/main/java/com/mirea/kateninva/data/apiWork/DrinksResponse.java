...
public class DrinksResponse {
    ...
    private List<com.mirea.kateninva.domain.models.Drink> drinks;

    public List<com.mirea.kateninva.domain.models.Drink> getDrinks() {
        return drinks;
    }

    public void setDrinks(List<com.mirea.kateninva.domain.models.Drink> drinks) {
        this.drinks = drinks;
    }

    public static class DrinkResp {
